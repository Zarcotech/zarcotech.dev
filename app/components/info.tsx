function Info() {
  return (
    <div className="w-[320px] rounded-2xl border border-gray-300/70 bg-white/70 p-4 text-gray-900 shadow-xl backdrop-blur-sm dark:border-white/30 dark:bg-black/35 dark:text-white">
